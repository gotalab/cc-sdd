...
- **Отсутствует шаблон**: Если файлы шаблонов не существуют в `{{KIRO_DIR}}/settings/templates/specs/`, сообщить об ошибке с указанием отсутствующего файла и предложить проверить настройку репозитория
- **Конфликт каталогов**: Если имя функции уже существует, добавить числовой суффикс (например, `имя-функции-2`) и уведомить пользователя об автоматическом разрешении конфликта
- **Ошибка записи**: Сообщить об ошибке с указанием пути и предложить проверить права доступа или дисковое пространство
